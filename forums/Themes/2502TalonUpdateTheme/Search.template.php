...
function template_results()
{
	...
	echo '
		<div class="cat_bar">
			<h3 class="catbg">
				<span class="ie6_header floatleft">', $txt['mlist_search_results'],':&nbsp;',$context['search_params']['search'],'</span>
				
				<span class="cat_bar_trinket">';
					if (!empty($options['display_quick_mod']) && $options['display_quick_mod'] == 1)
					echo '
							<input class="floatright" type="checkbox" onclick="invertAll(this, this.form, \'topics[]\');" class="input_check" />';
				echo '
				</span>
			</h3>
		</div>
