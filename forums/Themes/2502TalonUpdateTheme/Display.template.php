...
function template_main()
{
	...
	if (!empty($context['linked_calendar_events']))
	{
		echo '
			<div class="linked_events">
				<div class="cat_bar">
					<div class="catbg">
						<div class="cat_bar_title">', $txt['calendar_linked_events'], '</div>
					</div>
				</div>
				<div class="windowbg">
					<span class="topslice"><span></span></span>
		...
		foreach ($context['linked_calendar_events'] as $event)
		{
			...
			print_r($event);
			echo '</pre></div>';
			//print_r(date('n', strtotime($event['start_date'])));
			...
			echo '
							<li>
								...
								<a href="', $scripturl ,'?action=calendar;year=', date('Y', strtotime($event['start_date'])) ,';month=', date('n', strtotime($event['start_date'])) ,'"><img src="' . $settings['images_url'] . '/icons/calendar.gif" alt="" title="' . $txt['calendar'] . '" /></a>
							</li>';
		}
		echo '
						</ul>
	...
	echo '
			<div id="forumposts">
				<div class="cat_bar">
					<div class="catbg">
						<div class="cat_bar_title">', $context['subject'], '</div>
						
						<div class="cat_bar_trinket">
							<img src="', $settings['images_url'] ,'/2502/info_trinket.png" alt="Info" />
							<div class="cat_bar_trinket_tooltip">
								<div>', $txt['views'] ,': ', $context['num_views'] ,'</div>
								<div>', $txt['replies'], ': ', $context['num_replies'] ,'</div>
							</div>
						</div>
					</div>
				</div>';
