...
function loadTheme($id_theme = 0, $initialize = true)
{
	...
	$context['header_logo_url_html_safe'] = empty($settings['header_logo_url']) ? '' : $smcFunc['htmlspecialchars'](str_replace('{theme_url}', $settings['theme_url'], $settings['header_logo_url']));
