...
{
	global $context, $modSettings, $user_info, $txt, $scripturl, $homeurl;
		...
		$buttons = array(
			...
			'about' => array(
				...
				'sub_buttons' => array(
					'first' => array(
						'title' => $txt['FRCfirst'],
						'href' => $homeurl . '/about/?about=first',
						'show' => true,
					),
					'talonrobotics' => array(
						'title' => $txt['talonrobotics'],
						'href' => $homeurl . '/about/?about=talonrobotics',
						'show' => true,
					),
					'timeline' => array(
						'title' => $txt['timeline'],
						'href' => $homeurl . '/about/?about=timeline',
						'show' => true,
						'is_last' => true,
					),
				),
			...
			'for_parents' => array(
				'title' => $txt['for_parents'],
				'href' => $homeurl . '/for-parents/',
				'show' => true,
				'sub_buttons' => array(
					'get_involved' => array(
						'title' => $txt['get_involved'] ,
						'href' => $homeurl . '/for-parents/?tab=getinvolved',
						'show' => true,
					),
					'parents_faq' => array(
						'title' => $txt['faq'],
						'href' => $homeurl . '/for-parents/?tab=faq',
						'show' => true,
					),
					'youth_programs' => array(
						'title' => $txt['youth_programs'],
						'href' => $homeurl . '/for-parents/?tab=youthprograms',
						'show' => true,
						'is_last' => true,
					),
				),
			...
			'the_sprocket' => array(
				'title' => $txt['the_sprocket'],
				'href' => $homeurl . '/the-sprocket/',
				'show' => true,
				'sub_buttons' => array(
				),
				'is_last' => $context['right_to_left'],
			...
			/*
			'ten_thousand_lakes_regional' => array(
				'title' => $txt['ten_thousand_lakes_regional'],
				'href' => $homeurl . '/10000_lakes_regional/',
				'show' => true,
				'sub_buttons' => array(
				),
				'is_last' => $context['right_to_left'],
	...
	elseif (!empty($_GET['for_parents']))
	{
		$current_action = 'for_parents';
	}
